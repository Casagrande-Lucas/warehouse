...
<template>
    <div class="relative overflow-hidden bg-white">
            ...
            <div class="relative px-4 pt-6 sm:px-6 lg:px-8">
              <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                <div class="flex flex-shrink-0 flex-grow items-center lg:flex-grow-0">
                  <div class="flex w-full items-center justify-between md:w-auto">
                    <a href="#">
                      ...
                      <img alt="Warehouse" class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" />
                    </a>
                ...
                <div class="hidden md:ml-10 md:block md:space-x-8 md:pr-4">
                    ...
                    <a v-if="$page.props.auth.user" :href="route('dashboard')" class="font-medium text-indigo-600 hover:text-indigo-500">Dashboard</a>
                    <a v-else :href="route('login')" class="font-medium text-indigo-600 hover:text-indigo-500">Log in</a>
                </div>
              </nav>
            </div>
          ...
          <main class="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div class="sm:text-center lg:text-left">
              <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                <span class="block xl:inline">Warehouse Management System</span>
                {{ ' ' }}
                <span class="block text-indigo-600 xl:inline">to streamline your business</span>
              </h1>
              <p class="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">WMS is a complete warehouse management system that meets all your day-to-day needs and beyond.</p>
      ...
      <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:h-full lg:w-full" src="https://media.istockphoto.com/photos/rows-of-shelves-picture-id1138429558?k=20&m=1138429558&s=612x612&w=0&h=SEojoXUHl6Di4plxrDgH28aY9J1yCTxFxH5uIlibDeo=" alt="" />
      </div>
    </div>
</template>
